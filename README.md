...
[![Version](https://img.shields.io/badge/version-0.1.0-f97316?style=flat-square)](https://github.com/sunbigfly/hacker-news-reader-lite/releases)
...
[安装脚本](https://raw.githubusercontent.com/sunbigfly/hacker-news-reader-lite/main/dist/hacker-news-reader-lite.user.js) · [产品设计](docs/PRD.md) · [架构说明](docs/ARCHITECTURE.md) · [质量门禁](docs/QUALITY_GATES.md)
</div>
...
2. 点击 [安装 Hacker News Reader Lite](https://raw.githubusercontent.com/sunbigfly/hacker-news-reader-lite/main/dist/hacker-news-reader-lite.user.js)。
